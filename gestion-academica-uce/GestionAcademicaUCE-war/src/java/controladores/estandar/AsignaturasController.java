...
import sesiones.estandar.AsignaturasFacade;
...
public class AsignaturasController implements Serializable {
    ...
    @EJB
    private sesiones.estandar.AsignaturasFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("AsignaturasCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("AsignaturasUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("AsignaturasDeleted"));
        if (!JsfUtil.isValidationFailed()) {
