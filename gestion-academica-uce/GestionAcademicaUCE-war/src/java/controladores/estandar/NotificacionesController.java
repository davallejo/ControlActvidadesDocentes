...
import sesiones.estandar.NotificacionesFacade;
...
public class NotificacionesController implements Serializable {
    ...
    @EJB
    private sesiones.estandar.NotificacionesFacade ejbFacade;
    ...
    public Notificaciones getNotificaciones(java.lang.Long id) {
