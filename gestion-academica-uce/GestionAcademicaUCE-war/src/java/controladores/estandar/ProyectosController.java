...
import sesiones.estandar.ProyectosFacade;
...
public class ProyectosController implements Serializable {
    ...
    @EJB
    private sesiones.estandar.ProyectosFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("ProyectosCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ProyectosUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ProyectosDeleted"));
        if (!JsfUtil.isValidationFailed()) {
