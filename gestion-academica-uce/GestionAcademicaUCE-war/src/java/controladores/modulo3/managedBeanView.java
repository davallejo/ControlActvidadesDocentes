 ...
 * @author Usuario
 */
@Named(value = "managedBeanView")
@ViewScoped
public class managedBeanView implements Serializable {
    ...
    private Periodo codPeriodo;//var para modificar
    ...
    private List<Silabos> silabosLista;
    ...
    public void listasTablas() {
        ...
        silabosLista=new ArrayList<>();
        silabosLista=sessionSilabo.listarSilabo();
        
        /*listaContenidos=new ArrayList<>();
        listaContenidos=sessionSilabo.listarContenidos();
        listaUnidades=new ArrayList<>();
        listaUnidades=sessionSilabo.listarUnidades();        */

    }

    public List<Silabos> getSilabosLista() {
        return silabosLista;
    }

    public void setSilabosLista(List<Silabos> silabosLista) {
        this.silabosLista = silabosLista;
    }
